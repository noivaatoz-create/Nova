      ...
      <main className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto p-6 md:p-8 space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-[hsl(220,18%,18%)] border border-[hsl(218,18%,25%)] rounded-md p-5" data-testid="stat-total-messages">
              <div className="flex items-center gap-3">
                <Mail className="h-5 w-5 text-[hsl(38,92%,50%)]" />
                <div>
                  <p className="text-[hsl(215,20%,60%)] text-sm font-medium">Total Messages</p>
                  <h3 className="text-white text-2xl font-bold tracking-tight">{totalMessages}</h3>
                </div>
              </div>
            </div>
            <div className="bg-[hsl(220,18%,18%)] border border-[hsl(218,18%,25%)] rounded-md p-5" data-testid="stat-new-messages">
              <div className="flex items-center gap-3">
                <MessageSquare className="h-5 w-5 text-emerald-400" />
                <div>
                  <p className="text-[hsl(215,20%,60%)] text-sm font-medium">New</p>
                  <h3 className="text-white text-2xl font-bold tracking-tight">{newCount}</h3>
                </div>
              </div>
            </div>
            <div className="bg-[hsl(220,18%,18%)] border border-[hsl(218,18%,25%)] rounded-md p-5" data-testid="stat-replied-messages">
              <div className="flex items-center gap-3">
                <MessageSquare className="h-5 w-5 text-[hsl(215,20%,60%)]" />
                <div>
                  <p className="text-[hsl(215,20%,60%)] text-sm font-medium">Replied</p>
              ...
              <table className="w-full text-left">
                <thead>
                  <tr className="border-b border-[hsl(218,18%,25%)]">
                    ...
                    <th className="p-4 text-[hsl(215,20%,60%)] text-xs font-medium uppercase tracking-wider">Name</th>
                    <th className="p-4 text-[hsl(215,20%,60%)] text-xs font-medium uppercase tracking-wider">Email</th>
                    <th className="p-4 text-[hsl(215,20%,60%)] text-xs font-medium uppercase tracking-wider">Subject</th>
                ...
                <tbody className="divide-y divide-[hsl(218,18%,25%)]/50">
                  {isLoading && (
                    <tr>
                      <td colSpan={6} className="py-12 text-center">
                        <p className="text-[hsl(215,20%,60%)]">Loading messages...</p>
                      </td>
                    </tr>
                  )}
                  {!isLoading && messages?.map((msg) => (
                    ...
                    >
                      ...
                      <td className="p-4 text-[hsl(215,20%,60%)] text-sm">{msg.email}</td>
                      ...
                      <td className="p-4">
                        <div className="flex items-center gap-1">
                          ...
                          <button
                            ...
                            className="p-1.5 rounded-md hover:bg-red-500/10 text-[hsl(215,20%,60%)] hover:text-red-400 transition-colors"
                  ...
                  {!isLoading && (!messages || messages.length === 0) && (
                    <tr>
                      <td colSpan={6} className="py-12 text-center">
                        <MessageSquare className="h-12 w-12 text-[hsl(215,20%,60%)]/30 mx-auto mb-3" />
                        <p className="text-[hsl(215,20%,60%)]">No messages yet</p>
                      </td>
                    </tr>
                  )}
                </tbody>
          ...
          <DialogContent className="bg-[hsl(220,20%,14%)] border-[hsl(218,18%,25%)] text-white max-w-lg">
            ...
            {selectedMessage && (
              <div className="space-y-4">
                ...
                <div className="border-t border-[hsl(218,18%,25%)] pt-4 flex justify-between items-center gap-4 flex-wrap">
                  <p className="text-[hsl(215,20%,60%)] text-xs">

      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="flex flex-col gap-6 max-w-2xl">
            ...
            <p className="text-lg text-[hsl(215,20%,60%)] max-w-lg leading-relaxed">
            ...
            <div className="flex flex-wrap gap-4 pt-4">
              ...
              <Link href="/product/jetclean-pro">
                <button className="flex items-center justify-center rounded-md border border-[hsl(218,18%,25%)] bg-[hsl(220,18%,18%)]/50 h-12 px-8 text-base font-medium text-white transition-all hover:bg-[hsl(220,18%,18%)] hover:border-[hsl(38,92%,50%)]/50" data-testid="button-watch-demo">
                  View Details
                </button>
              </Link>
            </div>
          ...
          <div className="relative lg:h-[600px] flex items-center justify-center">
            ...
            <div className="relative z-10 w-full max-w-md aspect-[3/4] rounded-2xl bg-gradient-to-b from-gray-800 to-black p-1 shadow-2xl ring-1 ring-white/10">
              <div className="h-full w-full rounded-xl bg-[hsl(220,18%,18%)] overflow-hidden relative">
                <img
                  alt="Novaatoz JetClean Pro Water Flosser"
                  className="h-full w-full object-cover opacity-90"
                  src="/images/hero-product.png"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-[hsl(220,20%,14%)] via-transparent to-transparent opacity-60" />
...
function ValuePropsSection() {
  ...
  return (
    <section className="py-24 bg-[hsl(220,20%,14%)] relative" data-testid="section-value-props">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-16 md:flex md:items-end md:justify-between gap-4">
          <div className="max-w-2xl">
            ...
            <p className="text-[hsl(215,20%,60%)] text-lg">Advanced engineering for a superior clean. We've stripped away the unnecessary to focus on pure performance.</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {features.map((f, i) => (
            <div key={i} className="group relative overflow-visible rounded-md border border-[hsl(218,18%,25%)] bg-[hsl(220,18%,18%)] p-8 transition-all hover:border-[hsl(38,92%,50%)]/50 hover:shadow-lg" data-testid={`card-feature-${i}`}>
              ...
              <p className="text-[hsl(215,20%,60%)]">{f.desc}</p>
            </div>
          ))}
        </div>
      </div>
...
function GalleryMarqueeSection() {
  ...
  return (
    <section className="py-20 bg-[hsl(220,18%,11%)] border-t border-[hsl(218,18%,25%)]/50 overflow-hidden" data-testid="section-gallery">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 mb-12">
        <div className="text-center max-w-3xl mx-auto">
          <h2 className="text-3xl font-bold tracking-tight text-white sm:text-4xl mb-4">Designed for Perfection</h2>
          <p className="text-[hsl(215,20%,60%)] text-lg">Every angle, every detail - crafted with precision engineering and premium materials.</p>
        </div>
      </div>
      <div className="space-y-4">
        <div className="flex animate-marquee-left">
          {[...row1, ...row1, ...row1].map((src, i) => (
            <div key={i} className="flex-shrink-0 w-[300px] h-[200px] mx-2 rounded-md overflow-hidden border border-[hsl(218,18%,25%)]/50">
...
function FeaturedProductsSection() {
  ...
  return (
    <section className="py-24 border-t border-[hsl(218,18%,25%)]/50 bg-[hsl(220,18%,11%)]" data-testid="section-featured-products">
        ...
        <div className="flex gap-6 mx-auto max-w-7xl min-w-max">
          {isLoading
            ? Array.from({ length: 4 }).map((_, i) => (
                <div key={i} className="w-[320px] rounded-md border border-[hsl(218,18%,25%)] bg-[hsl(220,18%,18%)] overflow-hidden">
            ...
            : products?.map((product) => (
                <div key={product.id} className="flex w-[320px] flex-col overflow-hidden rounded-md border border-[hsl(218,18%,25%)] bg-[hsl(220,18%,18%)] shadow-sm transition-all hover:shadow-md hover:border-[hsl(38,92%,50%)]/30 group" data-testid={`card-product-${product.id}`}>
                  ...
                  <div className="flex flex-1 flex-col p-5">
                    ...
                    <p className="text-sm text-[hsl(215,20%,60%)] mb-4 flex-1">{product.shortDescription}</p>
...
function ComparisonSection() {
  ...
  return (
    <section className="py-24 bg-[hsl(220,20%,14%)] relative overflow-hidden" data-testid="section-comparison">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-[hsl(215,20%,60%)]">Why settle for string when you can have a stream? See how we stack up against traditional methods.</p>
        </div>
        <div className="rounded-2xl overflow-hidden border border-[hsl(218,18%,25%)] bg-[hsl(220,18%,18%)]/60 backdrop-blur-xl">
          <div className="overflow-x-auto">
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="border-b border-[hsl(218,18%,25%)]/50">
                  <th className="p-6 text-sm font-medium text-[hsl(215,20%,60%)] w-1/3">Feature</th>
                    ...
                    <td className="p-6 text-center bg-[hsl(38,92%,50%)]/5">
                      {row.nova ? (
                        ...
                        <>
                          ...
                          {row.novaExtra && <span className="block text-xs text-[hsl(215,20%,60%)] mt-1">{row.novaExtra}</span>}
                        </>
                      ) : null}
                    </td>
                    <td className="p-6 text-center text-[hsl(215,20%,60%)]">
                      {row.floss ? (
                        <span>{row.floss}</span>
                      ) : row.flossGood === false ? (
                        <>
                          <XCircle className="h-5 w-5 text-red-400 mx-auto" />
                          {row.flossExtra && <span className="block text-xs text-[hsl(215,20%,60%)] mt-1">{row.flossExtra}</span>}
                        </>
                      ) : (
...
function ReviewsPreviewSection() {
  ...
  return (
    <section className="py-24 bg-[hsl(220,18%,11%)] border-t border-[hsl(218,18%,25%)]/50" data-testid="section-reviews-preview">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex items-end justify-between gap-4 mb-12">
          <div>
            <h2 className="text-3xl font-bold tracking-tight text-white sm:text-4xl mb-4">What Our Customers Say</h2>
            <p className="text-[hsl(215,20%,60%)] text-lg">Real reviews from real customers who made the switch.</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {displayReviews.map((review) => (
            <div key={review.id} className="rounded-md border border-[hsl(218,18%,25%)] bg-[hsl(220,18%,18%)] p-6" data-testid={`card-review-${review.id}`}>
...
function CTASection() {
  return (
    <section className="py-24 bg-[hsl(220,20%,14%)] relative overflow-hidden" data-testid="section-cta">
      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        <p className="text-[hsl(215,20%,60%)] text-lg mb-8 max-w-2xl mx-auto">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          ...
          <Link href="/about">
            <button className="rounded-md border border-[hsl(218,18%,25%)] bg-[hsl(220,18%,18%)]/50 h-12 px-8 text-base font-medium text-white transition-all hover:bg-[hsl(220,18%,18%)] hover:border-[hsl(38,92%,50%)]/50" data-testid="button-learn-more-cta">
              Learn More
            </button>
          </Link>
        </div>

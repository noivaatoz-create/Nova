...
function HeroSection() {
  return (
    <section className="relative overflow-hidden py-20 sm:py-32 lg:pb-32 xl:pb-36" data-testid="section-hero">
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[500px] bg-[hsl(220,91%,55%)]/20 rounded-full blur-[120px] -z-10" />
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="flex flex-col gap-6 max-w-2xl">
            <div className="inline-flex items-center gap-2 rounded-full border border-[hsl(220,91%,55%)]/30 bg-[hsl(220,91%,55%)]/10 px-3 py-1 text-xs font-semibold text-[hsl(220,91%,55%)] w-fit" data-testid="badge-new-release">
              <span className="relative flex h-2 w-2">
                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-[hsl(220,91%,55%)] opacity-75" />
                <span className="relative inline-flex rounded-full h-2 w-2 bg-[hsl(220,91%,55%)]" />
              </span>
              New JetClean Pro Released
            </div>
            <h1 className="text-5xl sm:text-6xl lg:text-7xl font-black tracking-tight leading-[1.1] text-white">
              The Future of <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[hsl(220,91%,55%)] to-white" style={{ textShadow: "0 0 20px rgba(37,106,244,0.5)" }}>
                Oral Care
              </span>
            </h1>
            ...
            <div className="flex flex-wrap gap-4 pt-4">
              <Link href="/shop">
                <button className="flex items-center justify-center rounded-md bg-[hsl(220,91%,55%)] h-12 px-8 text-base font-bold text-white transition-all hover:bg-[hsl(220,91%,45%)] hover:scale-[1.02] shadow-[0_0_20px_rgba(37,106,244,0.4)]" data-testid="button-shop-hero">
                  Shop the Future
                </button>
              </Link>
              <Link href="/product/jetclean-pro">
                <button className="flex items-center justify-center rounded-md border border-[hsl(218,35%,17%)] bg-[hsl(220,38%,10%)]/50 h-12 px-8 text-base font-medium text-white transition-all hover:bg-[hsl(220,38%,10%)] hover:border-[hsl(220,91%,55%)]/50" data-testid="button-watch-demo">
                  View Details
                </button>
              </Link>
            </div>
          ...
          <div className="relative lg:h-[600px] flex items-center justify-center">
            <div className="absolute w-[400px] h-[400px] border border-[hsl(220,91%,55%)]/20 rounded-full animate-[spin_10s_linear_infinite]" />
              ...
              <div className="h-full w-full rounded-xl bg-[hsl(220,38%,10%)] overflow-hidden relative">
                ...
                <div className="absolute bottom-8 left-8 right-8">
                  <div className="flex justify-between items-end gap-4">
                    <div>
                      <p className="text-[hsl(220,91%,55%)] text-sm font-bold tracking-widest uppercase">Series X</p>
    ...
    <section className="py-24 bg-[hsl(220,40%,7%)] relative" data-testid="section-value-props">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-16 md:flex md:items-end md:justify-between gap-4">
          ...
          <Link href="/shop" className="hidden md:flex items-center gap-1 text-[hsl(220,91%,55%)] font-medium hover:text-[hsl(220,91%,45%)] mt-4 md:mt-0" data-testid="link-full-specs">
            View full specs <ArrowRight className="h-4 w-4" />
          </Link>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {features.map((f, i) => (
            <div key={i} className="group relative overflow-visible rounded-md border border-[hsl(218,35%,17%)] bg-[hsl(220,38%,10%)] p-8 transition-all hover:border-[hsl(220,91%,55%)]/50 hover:shadow-lg" data-testid={`card-feature-${i}`}>
              <div className="mb-6 inline-flex h-12 w-12 items-center justify-center rounded-md bg-[hsl(220,91%,55%)]/10 text-[hsl(220,91%,55%)] group-hover:bg-[hsl(220,91%,55%)] group-hover:text-white transition-colors">
    ...
    <section className="py-24 border-t border-[hsl(218,35%,17%)]/50 bg-[hsl(220,50%,4%)]" data-testid="section-featured-products">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 mb-10">
        <div className="flex items-end justify-between gap-4">
          ...
          <Link href="/shop" className="text-[hsl(220,91%,55%)] font-medium hover:text-[hsl(220,91%,45%)] hidden sm:flex items-center gap-1" data-testid="link-view-all-products">
        ...
        <div className="flex gap-6 mx-auto max-w-7xl min-w-max">
          {isLoading
            ...
            : products?.map((product) => (
                <div key={product.id} className="flex w-[320px] flex-col overflow-hidden rounded-md border border-[hsl(218,35%,17%)] bg-[hsl(220,38%,10%)] shadow-sm transition-all hover:shadow-md hover:border-[hsl(220,91%,55%)]/30 group" data-testid={`card-product-${product.id}`}>
...
function ComparisonSection() {
  ...
  return (
    <section className="py-24 bg-[hsl(220,40%,7%)] relative overflow-hidden" data-testid="section-comparison">
      <div className="absolute right-0 top-1/4 w-[500px] h-[500px] bg-[hsl(220,91%,55%)]/5 rounded-full blur-[100px] -z-10" />
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="border-b border-[hsl(218,35%,17%)]/50">
                  ...
                  <th className="p-6 text-lg font-bold text-[hsl(220,91%,55%)] w-1/3 text-center bg-[hsl(220,91%,55%)]/5">
              ...
              <tbody className="divide-y divide-[hsl(218,35%,17%)]/50">
                {rows.map((row, i) => (
                  <tr key={i}>
                    ...
                    <td className="p-6 text-center bg-[hsl(220,91%,55%)]/5">
                      {row.nova ? (
    ...
    <section className="py-24 bg-[hsl(220,50%,4%)] border-t border-[hsl(218,35%,17%)]/50" data-testid="section-reviews-preview">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex items-end justify-between gap-4 mb-12">
          ...
          <Link href="/reviews" className="hidden md:flex items-center gap-1 text-[hsl(220,91%,55%)] font-medium hover:text-[hsl(220,91%,45%)]" data-testid="link-all-reviews">
...
function CTASection() {
  return (
    <section className="py-24 bg-[hsl(220,40%,7%)] relative overflow-hidden" data-testid="section-cta">
      <div className="absolute inset-0 bg-gradient-to-r from-[hsl(220,91%,55%)]/10 via-transparent to-[hsl(220,91%,55%)]/5" />
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          <Link href="/shop">
            <button className="rounded-md bg-[hsl(220,91%,55%)] h-12 px-8 text-base font-bold text-white transition-all hover:bg-[hsl(220,91%,45%)] hover:scale-[1.02] shadow-[0_0_20px_rgba(37,106,244,0.4)]" data-testid="button-shop-cta">
              Shop Now
            </button>
          </Link>
          <Link href="/about">
            <button className="rounded-md border border-[hsl(218,35%,17%)] bg-[hsl(220,38%,10%)]/50 h-12 px-8 text-base font-medium text-white transition-all hover:bg-[hsl(220,38%,10%)] hover:border-[hsl(220,91%,55%)]/50" data-testid="button-learn-more-cta">
              Learn More
            </button>
          </Link>
        </div>

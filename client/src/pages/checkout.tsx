  ...
  return (
    <div className="min-h-screen bg-[hsl(220,40%,7%)]">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
        <Link href="/shop" className="inline-flex items-center gap-2 text-[hsl(215,30%,65%)] hover:text-white mb-8 transition-colors" data-testid="link-back-shop">
        ...
        <form onSubmit={handleSubmit}>
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div>
              <div className="rounded-md border border-[hsl(218,35%,17%)] bg-[hsl(220,38%,10%)] p-6 sticky top-24">
                <h2 className="text-lg font-bold text-white mb-6">Order Summary</h2>
                <div className="space-y-4 mb-6">
                  {items.map((item) => (
                    <div key={item.id} className="flex gap-3" data-testid={`checkout-item-${item.id}`}>
                      <div className="h-14 w-14 rounded-md overflow-hidden bg-[hsl(218,35%,17%)] flex-shrink-0">
                ...
                <div className="space-y-2 border-t border-[hsl(218,35%,17%)] pt-4">

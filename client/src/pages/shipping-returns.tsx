    ...
    <div className="min-h-screen bg-[hsl(220,20%,14%)]">
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-[hsl(215,20%,60%)] text-lg">Everything you need to know about how we ship your orders and handle returns at Novaatoz.</p>
        </div>

        <div className="space-y-12">
          <section>
            <h2 className="text-xl font-bold text-white mb-4" data-testid="text-section-shipping-policy">Shipping Policy</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-white mb-4" data-testid="text-section-international-shipping">International Shipping</h2>
            <div className="space-y-4 text-[hsl(215,20%,60%)] leading-relaxed text-sm">
          ...
          <section>
            <h2 className="text-xl font-bold text-white mb-4" data-testid="text-section-order-processing">Order Processing</h2>
            <div className="space-y-4 text-[hsl(215,20%,60%)] leading-relaxed text-sm">
          ...
          <section>
            <h2 className="text-xl font-bold text-white mb-4" data-testid="text-section-returns">Returns</h2>
            <div className="space-y-4 text-[hsl(215,20%,60%)] leading-relaxed text-sm">
          ...
          <section>
            <h2 className="text-xl font-bold text-white mb-4" data-testid="text-section-refund-process">Refund Process</h2>
            <div className="space-y-4 text-[hsl(215,20%,60%)] leading-relaxed text-sm">
          ...
          <section>
            <h2 className="text-xl font-bold text-white mb-4" data-testid="text-section-exchanges">Exchanges</h2>
            <div className="space-y-4 text-[hsl(215,20%,60%)] leading-relaxed text-sm">
          ...
          <section>
            <h2 className="text-xl font-bold text-white mb-4" data-testid="text-section-damaged-items">Damaged Items</h2>
            <div className="space-y-4 text-[hsl(215,20%,60%)] leading-relaxed text-sm">
          ...
          <section>
            <h2 className="text-xl font-bold text-white mb-4" data-testid="text-section-contact-support">Contact Us</h2>
            <div className="space-y-4 text-[hsl(215,20%,60%)] leading-relaxed text-sm">

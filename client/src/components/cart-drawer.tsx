      ...
      <SheetContent side="right" className="bg-[hsl(220,40%,7%)] border-[hsl(218,35%,17%)] w-full sm:max-w-md flex flex-col" data-testid="cart-drawer">
        ...
        {items.length === 0 ? (
          <div className="flex-1 flex flex-col items-center justify-center gap-4 text-center" data-testid="text-empty-cart">
            <ShoppingBag className="h-16 w-16 text-[hsl(215,30%,65%)]/30" />
            <div>
          ...
          <>
            ...
            <div className="flex-1 overflow-y-auto mt-4 space-y-4 pr-1">
              {items.map((item) => (
                <div key={item.id} className="flex gap-4 rounded-md border border-[hsl(218,35%,17%)] bg-[hsl(220,38%,10%)] p-3" data-testid={`cart-item-${item.id}`}>
                  <div className="h-20 w-20 rounded-md overflow-hidden bg-[hsl(218,35%,17%)] flex-shrink-0">
                  ...
                  <div className="flex flex-1 flex-col justify-between min-w-0">
                    <div className="flex justify-between items-start gap-2">
                      ...
                      <button
                        ...
                        className="text-[hsl(215,30%,65%)] hover:text-white flex-shrink-0"
                    ...
                    <div className="flex items-center justify-between mt-2">
                      <div className="flex items-center gap-2 border border-[hsl(218,35%,17%)] rounded-md">
                        <button
                          onClick={() => updateQuantity(item.id, item.quantity - 1)}
                          className="p-1.5 text-[hsl(215,30%,65%)] hover:text-white"
            ...
            <div className="mt-auto pt-4 border-t border-[hsl(218,35%,17%)] space-y-3">
              ...
              <Link href="/shop" onClick={() => setIsOpen(false)}>
                <Button
                  variant="outline"
                  className="w-full border-[hsl(218,35%,17%)] text-[hsl(215,30%,65%)] mt-2"
